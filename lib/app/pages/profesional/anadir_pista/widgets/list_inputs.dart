        ...
        children: [
                ...
                child: VibratingWidget(
                  ...
                  child: Obx(
                    () => InputPista(
                      ...
                      context: context,
                      labelText: 'Tipo',
                      itemsDD: const ['Cristal', 'Hormigón'],
          ...
          Row(
            ...
            children: [
              Expanded(
                child: VibratingWidget(
                  controller: self.selectSocio.anim,
                  child: Obx(() => InputPista(
                      key: self.selectSocio.key,
                      controller: self.selectSocio.controller,
                      focusNode: self.selectSocio.focus,
                      context: context,
                      labelText: 'Tipo reserva',
                      itemsDD: const ['Total', 'Parcial'],
                      onChanged: (val) =>
                          self.selectSocio.isValidate.value = false,
                      isValidate: self.selectSocio.isValidate.value,
                      onValidator: (val) => self.validarInputController(
                          val,
                          self.selectSocio.isValidate,
                          self.selectSocio.anim,
                          self.selectSocio.key))),
                ),
              ),
              4.0.sw,
              Expanded(
                child: VibratingWidget(
                  controller: self.plazasReservar.anim,
                  child: Obx(
                    () => InputPista(
                      key: self.plazasReservar.key,
                      controller: self.plazasReservar.controller,
                      focusNode: self.plazasReservar.focus,
                      context: context,
                      labelText: 'Clientes',
                      itemsDD: const ['Socios', 'No socios', 'Ambos'],
                      onChanged: (val) =>
                          self.plazasReservar.isValidate.value = false,
                      isValidate: self.plazasReservar.isValidate.value,
                      onValidator: (val) => self.validarInputController(
                          val,
                          self.plazasReservar.isValidate,
                          self.plazasReservar.anim,
                          self.plazasReservar.key),
                    ),
                  ),
                ),
              )
...
// Build inputs del socio o no socio
  Widget buildContainerSocioNew({
    ...
    // self.selectSocio.controller.text == "Ambos"
    return Container(
